...
import { isRegistryPublic, MAIN_NAV } from "@/config/site"
import { getAllDocs, getBlogDocs } from "@/features/doc/data/documents"
...
export function SiteHeader() {
  const posts = isRegistryPublic ? getAllDocs() : getBlogDocs()
    ...
    >
      ...
      >
        ...
        <div className="flex items-center *:first:mr-2">
          <CommandMenu posts={postPreviews} projects={projectPreviews} />
          <NavItemGitHub />
